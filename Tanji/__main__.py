...
buttons = [
    [
        InlineKeyboardButton(text="About Tanjirou Bot", callback_data="Tanji_"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text=" Add mein your Group✨",url="t.me/Tanji_kamado_bot?startgroup=new"),
    ],
]
