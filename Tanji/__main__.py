...
PM_START_TEXT = """
*Hello {} !*
• I'm Tanjirou Kamado bot to help to maintain your groups [🌟](https://telegra.ph/file/171cdd6ef81e08a52007f.mp4)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    [
        InlineKeyboardButton(text="About Tanjirou Kamado bot", callback_data="siesta_"),
    ],
    [
    ...
    if query.data == "tanji_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Source Code", url="https://github.com/Lynncep77/TanjirouRobot"),
                 ],
                 [
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Tanjirou", url="https://t.me/Lynncept_iz_here"),
                    InlineKeyboardButton(text="Yorichi", url="https://t.me/girls_lob"),
                 ],
                 [
                    InlineKeyboardButton(text="Ryu", url="https://t.me/Ryu_God"),
