...
from Tanji.modules.log_channel import gloggable
...
def addwhitelist(update: Update, context: CallbackContext) -> str:
    ...
    data["beastbreathers"].append(user_id)
...
def addtiger(update: Update, context: CallbackContext) -> str:
    ...
    data["waterbreathers"].append(user_id)
...
def removetiger(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in TIGERS:
        ...
        data["waterbreathers"].remove(user_id)
...
WHITELIST_HANDLER = CommandHandler(
    ("addwhitelist", "trainbeast"), addwhitelist, run_async=True
)
UNSUDO_HANDLER = CommandHandler(
    ("removesudo", "removethunder"), removesudo, run_async=True
)
UNSUPPORT_HANDLER = CommandHandler(
    ("removesupport", "removewind"), removesupport, run_async=True
)
UNTIGER_HANDLER = CommandHandler(("removetwater"), removetiger, run_async=True)
UNWHITELIST_HANDLER = CommandHandler(
    ("removewhitelist", "removebeast"), removewhitelist, run_async=True
)
WHITELISTLIST_HANDLER = CommandHandler(
    ["whitelistlist", "beastlist"], whitelistlist, run_async=True
)
TIGERLIST_HANDLER = CommandHandler(["waterlist"], tigerlist, run_async=True)
SUPPORTLIST_HANDLER = CommandHandler(
    ["supportlist", "windlist"], supportlist, run_async=True
)
SUDOLIST_HANDLER = CommandHandler(["sudolist", "thunderlist"], sudolist, run_async=True)
DEVLIST_HANDLER = CommandHandler(["devlist", "flamelist"], devlist, run_async=True)
