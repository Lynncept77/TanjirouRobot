...
from Tanji.modules.sql.afk_sql import is_afk, set_afk
from Tanji.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += f"\n\n This user use chutiya Breathing."
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/Tanjirou_updates/28)
"""
